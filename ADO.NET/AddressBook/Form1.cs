...
namespace AddressBook
{
    public partial class Form1 : Form
    {
        ...
        private void btConnrct_Click(object sender, EventArgs e)
        {
            // TODO: このコード行はデータを 'infosys202107DataSet.Person' テーブルに読み込みます。必要に応じて移動、または削除をしてください。
            this.personTableAdapter.Fill(this.infosys202107DataSet.Person);
        }

        private void btNameFilter_Click(object sender, EventArgs e)
        {
            this.personTableAdapter.FillByName(this.infosys202107DataSet.Person, tbNameSearch.Text);
        }
        ...
        private void btSave_Click(object sender, EventArgs e)
        {
            ...
            //this.personTableAdapter.Update(this.infosys202107DataSet);    //特定の一つのテーブルのみ更新
        }
        ...
        {
            this.personTableAdapter.FillByBirthday(this.infosys202107DataSet.Person, (DateTime)dtpFilter.Value);
        }
    }
