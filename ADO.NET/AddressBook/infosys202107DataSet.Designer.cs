...
SELECT No, Name, Birthday, Telephone, Memo FROM Person WHERE (No = @No)";
        ...
        public virtual int FillByBirthday(infosys202107DataSet.PersonDataTable dataTable, string birthday) {
        ...
        public virtual infosys202107DataSet.PersonDataTable GetDataBy1(string birthday) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((birthday == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
